...
![image-20240403222149240](./images/taskman/image-20240403222149240.png)
...
1. 编排,告警出发的编排
1. 手动触发/自动触发:触发模式,手动触发需要在告警处点击按钮
1. 描述:描述行为

编排手动触发:进入告警页面,找到按钮
![企业微信截图_1712155960618](./images/taskman/%E4%BC%81%E4%B8%9A%E5%BE%AE%E4%BF%A1%E6%88%AA%E5%9B%BE_1712155960618.png)
